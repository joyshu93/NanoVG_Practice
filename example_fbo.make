...
ifeq ($(config),debug_native)
  RESCOMP = windres
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/native/Debug/example_fbo
...
ifeq ($(config),debug_x64)
  ...
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/x64/Debug/example_fbo
  DEFINES += -DNANOVG_GLEW -D_CRT_SECURE_NO_WARNINGS -DDEBUG
  INCLUDES += -I../src -I../example
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x32)
  ...
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/x32/Debug/example_fbo
  DEFINES += -DNANOVG_GLEW -D_CRT_SECURE_NO_WARNINGS -DDEBUG
  INCLUDES += -I../src -I../example
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_native)
  ...
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/native/Release/example_fbo
...
ifeq ($(config),release_x64)
  ...
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/x64/Release/example_fbo
  DEFINES += -DNANOVG_GLEW -D_CRT_SECURE_NO_WARNINGS -DNDEBUG
  INCLUDES += -I../src -I../example
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x32)
  ...
  TARGETDIR = .
  TARGET = $(TARGETDIR)/example_fbo.exe
  OBJDIR = obj/x32/Release/example_fbo
  DEFINES += -DNANOVG_GLEW -D_CRT_SECURE_NO_WARNINGS -DNDEBUG
  INCLUDES += -I../src -I../example
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/example_fbo.o: ../example/example_fbo.c
	@echo $(notdir $<)
